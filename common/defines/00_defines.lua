...
NGame = {
	...
	LAG_DAYS_FOR_PAUSE = 1100,						-- Days of client lag for pause of gamespeed.
	GAME_SPEED_SECONDS = { 6000.0, 0.15, 0.10, 0.06, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NCountry = {
	...
	SPECIAL_FORCES_CAP_BASE = 1.0,					-- Max ammount of special forces battalions is total number of non-special forces battalions multiplied by this and modified by a country modifier
	SPECIAL_FORCES_CAP_MIN = 9999999,				-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NProduction = {
	...
	RAILWAY_GUN_MAX_MIL_FACTORIES_PER_LINE = 150,
	...
	MIN_POSSIBLE_TRAINING_MANPOWER = 999999,	-- How many deployment lines minimum can be training
...
NFocus = {
	...
	MAX_SAVED_FOCUS_PROGRESS = 25,				-- This much progress can be saved while not having a focus selected
},
